  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.existingPortfolio != null ? AppLocalizations.of(context)!.updateGoal : AppLocalizations.of(context)!.newGoal,
            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.length25Characters(_nameController.text.length.toString()),
